...
<body class="">
    ...
    <section class="hero w-full h-screen relative overflow-hidden">
        ...
        <div class="w-full flex justify-center absolute top-0 h-full overflow-hidden hero-container">
            ...
            <a href="#kandidat"
                ...
                <p class="text-white relative min-w-96 text-center ">Berikan Suara</p>
            </a>
            <div id="myDiv"
    ...
    <section id="kandidat" class=" w-full h-screen bg-white relative border border-white ">
        <div class="vote-loading absolute w-full h-full z-40 flex justify-center items-center hidden">
            <div class="w-32  aspect-square rounded-xl flex justify-center items-center bg-black/75">
        ...
        <div id="kandidat-1"
            ...
            <div class="detail-card relative bg-secondary rounded-3xl mx-auto max-w-3xl h-fit relative flex">
                ...
                <div class="left inline-block w-2/5 relative top-0 bottom-0 left-0">
                    ...
                    <img src="<?= base_url(); ?>public/assets/images/detail-kandidat-1.webp"
                        ...
                        <div class="bg-white rounded-2xl px-5 py-3 pt-5 relative h-64">
                            <div class="visi-misi-container overflow-y-auto h-full">
                                ...
                                <p>
                                    ...
                                    misi: membuat program yang memotivasi dan membangun nilai tanggung jawab; menanamkan
                                    sifat disiplin; membuat pengurus OSIS menjadi teladang yang baik untuk semua orang;
                                    menjalin hubungan yang baik dengan semua; menjadikan siswi yang memiliki sifat
                                    empati.
                                </p>
                            </div>
                        </div>
        ...
        <div id="kandidat-2"
            ...
            <div class="detail-card relative bg-secondary rounded-3xl mx-auto max-w-3xl h-fit relative flex">
                ...
                <div class="left inline-block w-2/5 relative top-0 bottom-0 left-0">
                    ...
                    <img src="<?= base_url(); ?>public/assets/images/detail-kandidat-2.webp"
                        class="absolute bottom-0  w-full object-contain" alt="">
                </div>
                <div class="right inline-block w-3/5 h-full pr-5 pb-16 pt-10">
                    <div class="visi-misi relative">
        ...
        <div id="kandidat-3"
            ...
            <div class="detail-card relative bg-secondary rounded-3xl mx-auto max-w-3xl h-fit relative flex">
                ...
                <div class="left inline-block w-2/5 relative top-0 bottom-0 left-0">
                    ...
                    <img src="<?= base_url(); ?>public/assets/images/detail-kandidat-3.webp"
                        class="absolute bottom-0  w-full object-contain" alt="">
                </div>
                <div class="right inline-block w-3/5 h-full pr-5 pb-16 pt-10">
                    <div class="visi-misi relative">
