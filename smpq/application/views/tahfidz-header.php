...
<body
    class="font-Poppins overflow-y-h text-black relative max-w-[3000px] relative  bg-gray-100 bg-[url('../images/wa-bg-teal.webp')] bg-repeat bg-[length:400px_800px]">
    <div
        class="hidden full-view w-full h-screen bg-black z-50 bg-opacity-[0.75] fixed overflow-y-scroll backdrop-blur-xl text-white flex justify-center items-center flex-col p-3">
    ...
    <!-- <divp-[[]] -->
    <header class="fixed top-0 w-full z-40 text-white bg-black/0 transition-all duration-200">
        <div
        ...
        <div
            class="main-header bg-secondary  w-full px-10 md:px-20 flex justify-between items-center relative header-container font-Poppins transition-all duration-200 ease-in-out z-50">
