...
<body
    class="font-Poppins overflow-y-h text-black relative max-w-[3000px] relative  bg-gray-100 bg-[url('../images/bg-logo.png')] bg-repeat bg-[length:100px_100px] md:bg-[length:200px_200px]">
    <div class="loader wow animate__animated animate__pulse animate__infinite">
    </div>
    <div class="navigasi-baru w-96 h-16 bg-green-400 mx-auto fixed bottom-0 z-60 rounded-xl"></div>
    <div
    ...
    <!-- <divp-[[]] -->
    <header class="fixed top-0 w-full z-50 text-white bg-black/0 transition-all duration-200">
        <div
            ...
            <div class="right flex items-center">
                <div class="search-bar h-6 w-40 mr-2 flex justify-center items-center relative">
                    <input type="text" id="search" placeholder="telusuri"
                        class="h-full w-full text-secondary text-xs outline-none rounded-full px-2 bg-white ">
                ...
                <div class="nav-container flex md:items-center">
                    ...
                    <nav
                        ...
                        <ul class="static md:flex justify-between items-center">
                            <li
                                class="px-2 w-full  hover:bg-gray-100 md:hover:bg-transparent rounded-lg dropdown-parent">
                                <div class="relative inline-block text-left menu ml-3 py-2  w-full">
                                    <div>
                                        <button id=""
                                            class=" inline-flex inline-block w-full font-normal rounded-md py-2">
                                            Profil
                                        </button>
                                    </div>
                                    <div id=""
    ...
    <section class="search-result w-full bg-white h-screen fixed  left-0 top-24 z-50 hidden">
