...
<body class="">
    <a href="<?= base_url(); ?>" class="absolute top-2 left-2 w-8 aspect-square z-40">
        <img src="<?= base_url(); ?>public/assets/images/icons/home-icon.webp" class="w-full h-full object-contain"
            alt="">
    </a>
    <div
    ...
    <section id="kandidat" class=" w-full h-screen bg-white relative border border-white ">
        ...
        <div id="kandidat-1"
            ...
            <div class="detail-card relative select-none  rounded-3xl mx-auto max-w-3xl h-fit relative flex">
                ...
                <div class="w-28 h-11 rounded-full -bottom-16 right-0 absolute bg-secondary text-white uppercase flex justify-center items-center cursor-pointer hover:scale-105 animation ease-out duration-150 font-bold vote-btn  w-full z-30"
                    data-nis="23018" data-name="Faaza">vote</div>
                <div class="left inline-block w-2/5 relative top-0 bottom-0 left-0 flex justify-center items-center  h-96 overflow-hidden">
                    <div class="absolute w-full h-full bottom-0 bg-gradient-to-t from-white to-blue-200 z-10 rounded-3xl"></div>
                    <div
                ...
                <div class="right inline-block w-3/5 h-full  pr-5 pl-3">
                    <div class="visi-misi relative">
                        <div class="nama font-bold text-xl absolute top-0 left-0 bg-orange-400 p-2 px-5 rounded-full text-white z-10">
                            Faaza</div>

                        <div class="rounded-2xl py-3 pt-5 relative h-96">
        ...
        <div id="kandidat-2"
            ...
            <div class="detail-card relative bg-secondary rounded-3xl mx-auto max-w-3xl h-fit relative flex">
                ...
                <div class="w-28 h-11 rounded-full bottom-0 right-0 absolute bg-orange-500 text-white uppercase flex justify-center items-center cursor-pointer hover:scale-105 animation ease-out duration-150 font-bold vote-btn"
                    data-nis="23025" data-name="Nazila">vote</div>
                <div class="left inline-block w-2/5 relative top-0 bottom-0 left-0">
                    <div
                        class="kandidat-return w-10 aspect-square rounded-full bg-white absolute z-20 top-2 left-2 p-2 cursor-pointer shadow-sm ">
                        <img src="<?= base_url(); ?>public/assets/images/arrow-left-circle-primary.png"
        ...
        <div id="kandidat-3"
            ...
            <div class="detail-card relative bg-secondary rounded-3xl mx-auto max-w-3xl h-fit relative flex">
                <img src="<?= base_url(); ?>public/assets/images/detail-kandidat-corner.png"
                    class="w-36 h-fit bottom-0 right-0 absolute" alt="">
                <div class="w-28 h-11 rounded-full bottom-0 right-0 absolute bg-orange-500 text-white uppercase flex justify-center items-center cursor-pointer hover:scale-105 animation ease-out duration-150 font-bold vote-btn"
                    data-nis="23027" data-name="Sania">vote</div>
                <div class="left inline-block w-2/5 relative top-0 bottom-0 left-0">
                    <div
                        class="kandidat-return w-10 aspect-square rounded-full bg-white absolute z-20 top-2 left-2 p-2 cursor-pointer shadow-sm ">
                        <img src="<?= base_url(); ?>public/assets/images/arrow-left-circle-primary.png"
    ...
    <script>
        ...
        authSubmitBtn.addEventListener("click", () => {
            ...
            // Use the fetch API
            fetch(`http://localhost/smpq/pilketos/getDPT?nis=${input.value}&password=${password.value}`)
                .then(response => {
                    if (!response.ok) {
            ...
            fetch(`http://localhost/smpq/pilketos/getVoteCount`)
                ...
                .then(data => {
                    ...
                    if (result.total_vote > totalVt) {
                        ...
                        val.push((result.total_dpt) - result.total_vote);
                        let labl = [];
                        labl.push("Suara Masuk");
                        labl.push("Belum Memilih");
                        // const value = val;
                        // const label = labl;
                        ...
                        let dt = [{
                            ...
                            marker: {
                                colors: ['#1e3a8a', '#fff'] // Array of custom colors
                            }
                        }];
