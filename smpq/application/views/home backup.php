...
<section class="hero  relative w-full bg-black">
    <div
        class="slider-indicator animate-pulse absolute top-0 left-0 h-1 bg-gradient-to-r from-primary/20 to-primary z-80 flex justify-end items-center">
    ...
    <div
        ...
        <div class="flex justify-center mb-2  pt-5 mx-auto md:mx-0 logo p-5 md:px-10">
            <img src="<?= base_url(); ?>public/assets/images/logo.png" class=" w-32 mr-10 md:w-40 logo" alt="">
            <img src="<?= base_url(); ?>public/assets/images/akreditasi.webp" class="w-16  object-contain md:w-24"
                alt="">
        ...
        <div class="pl-5 md:pl-10">
            ...
            <p>Terakreditasi A</p>
            <p>
                <a href="https://ban-pdm.id/documents/view/1734585270_ffcca3f6c61db996ae50.pdf" target="_blank">SK
                    NOMOR:
                    266/BAN-PDM/SK/2024</a>
            </p>
...
<section class=" px-1 md:px-5   pb-5 " id="berita">
    <div class="featured p-1 flex flex-col md:flex-row gap-5 mb-5 items-stretch">
        <?php if ($recentNews != null): ?>
            <?php foreach ($recentNews as $key => $n): ?>
                <?php if ($key == 0): ?>
                    <div class="featured-main md:w-3/5 lg:w-8/12 shadow-custom rounded-xl overflow-hidden relative" data-id="<?= $n['id'] ;?>">

                        <img class="w-full aspect-video md:h-0 object-cover  "
                            src="<?= base_url(); ?>public/assets/images/<?= $n['hd']; ?>">

                        <div class="detail absolute bottom-0 left-0 w-full h-full p-2  md:p-10 flex items-end">
                            <h2 class="text-lg  md:text-4xl text-white font-bold font-Montserrat">
                                <?= $n['title']; ?>
                            </h2>
                        </div>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="featured-nav w-full md:w-2/5 lg:w-4/12">
            <div class=" rounded-xl shadow-custom w-full min-h-96">
                <div class="w-full grid grid-cols-2">
                    <div class="featured-menu bg-white relative rounded-t-xl  p-2 text-center latest active font-bold  opacity-100 transition-all hover:cursor-pointer"
                    ...
                    <div class="featured-menu bg-gray-400 relative rounded-t-xl  p-2 text-center opacity-75 popular shadow-featuredShadow transition-all hover:cursor-pointer"
                ...
                <div class="featured-container transition-all p-3 rounded-b-xl bg-white font-Montserrat uppercase text-xxs font-semibold latest-container"
                    data-featured="latest">
                    <?php if ($recentNews != null): ?>
                        <?php foreach ($recentNews as $key => $n): ?>
                            <a href="<?= base_url()?>berita/baca/<?= $n['id'];?>" class="flex p-2 gap-2">
                ...
                <div class="featured-container transition-all p-3 rounded-b-xl bg-white font-Montserrat uppercase text-xxs font-semibold popular-container hidden"
                    data-featured="popular">
    ...
    <div class="berita-outer-container flex flex-col md:flex-row gap-5" data-wow-duration=".5s" data-wow-delay=".25s"
        data-wow-offset="100">
        <div class="berita-container w-full p-1 md:w-3/5 lg:w-8/12">
            <?php if ($recentNews != null): ?>
                <?php foreach ($recentNews as $key => $n): ?>
                    <?php if ($key == 0) {
                        continue;
                    ...
                    ; ?>
                    <div class="berita-card w-full rounded-xl overflow-hidden  bg-white border flex mb-2"
                        ...
                        <div class="detail-berita p-2  w-9/12 bg-white">


                            <h2
                                class="judul-berita font-Montserrat font-bold text-gray-800 capitalize text-xs sm:text-base break-words">
                                <?= $n['title']; ?>
                            </h2>
...
<section class="sambutan  bg-secondary  px-5 lg:px-10 lg:px-40 py-20 lg:py-32 my-20 relative ">
    ...
    <div class="shadow-custom sambutan-container bg-no-repeat bg-left flex flex-col md:flex-row items-center lg:justify-around bg-white rounded-xl p-5 wow animate__animated animate__fadeInUp"
        data-wow-duration=".5s" data-wow-delay=".25s" data-wow-offset="100">
        ...
        <div class="teks mb-5 md:w-3/5   text-gray-700 text-[.9rem] md:flex-2 font-semibold">
