<section class="mt-20 p-5">
    ...
    <h1 class="text-blue-500"> <a href="<?= base_url() ?>admin">Admin</a> / Berita</h1>
  
        <a href="<?= base_url() ?>berita/create" class="inline-block w-fit aspect-square px-3 py-1 my-5 rounded-full bg-secondary text-white aspect-square" id="tambah-berita-btn">+</a>
 


    <div class="admin berita-container h-fit w-full">
