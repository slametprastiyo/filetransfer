<section class="p-5 galeri pb-20 bg-white"> 
<div class="breadcrumbs mb-5">
    <a href="<?= base_url("admin") ;?>">Admin</a>
    <span>></span>
    <span>Galeri</span>
</div>
    <button class="px-3 py-1 bg-secondary rounded-xl text-white" id="tambah-galeri-btn">+</button>
...
<form action="<?= base_url("admin/galeri_upload") ;?>" id="tambah-galeri" method="POST" class="hidden p-5 absolute top-10 bg-white shadow-lg rounded-lg z-50" enctype="multipart/form-data">
       
       <div
           class="close-btn absolute right-2 bg-red-600 text-white w-6 rounded-full aspect-square flex justify-center items-center hover:cursor-pointer scale-125">
           x</div>
       ...
       <div class="mb-4">
           <input type="checkbox" id="isTahfidz" name="isTahfidz" value="value1">
           <label for="isTahfidz">Tahfidz?</label>
        </div>
