...
//   test.classList.add("animate__animated","animate__bounce");
//   setTimeout(()=>{
//     test.classList.remove("animate__animated","animate__bounce");
//   },2000)
// })
...
if (tambahBannerBtn != null) {
  tambahBannerBtn.addEventListener("click", () => {
    ...
    const bannerMobilePreview = formTambahBanner.querySelector(
      "img.banner-mobile-preview",
    );
    const bannerDesktopPreview = formTambahBanner.querySelector(
      "img.banner-desktop-preview",
    );
    const inputBannerMobile = formTambahBanner.querySelector("#banner-mobile");
    const inputBannerDesktop =
      formTambahBanner.querySelector("#banner-desktop");
            ...
            img.onload = function () {
              ...
              if (width / height > 0.5 && width / height < 0.6) {
                ...
                Swal.fire({
                  ...
                  icon: "error",
                  title:
                    "Rasio aspek tidak sesuai. Rasio seharusnya 6 x 19 (lebar x tinggi)",
                  showConfirmButton: false,
                  timer: 3000,
                });
                fileInput.value = "";
            ...
            img.onload = function () {
              ...
              if (width / height || (1.6 && width) || height < 1.88) {
                ...
                Swal.fire({
                  ...
                  icon: "error",
                  title:
                    "Rasio aspek tidak sesuai. Rasio seharusnya 16 x 9 (lebar x tinggi)",
                  showConfirmButton: false,
                  timer: 3000,
                });
                fileInput.value = "";
...
function changePriority(direction, idBanner) {
  ...
  xhr.open(
    "GET",
    baseURL + "admin/banner_priority/" + direction + "/" + idBanner,
  );
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      if (direction == "up") {
        ...
        movedBanner.classList.add("animate__animated", "animate__slideOutUp");
        upperBanner.classList.add("animate__animated", "animate__slideOutDown");
      ...
      if (direction == "down") {
        ...
        movedBanner.classList.add("animate__animated", "animate__slideOutDown");
        lowerBanner.classList.add("animate__animated", "animate__slideOutUp");
        movedBanner.style.setProperty("--animate-duration", "0.5s");
      ...
      if (direction == "top") {
        ...
        previousSiblings.forEach((e) => {
          e.classList.add("animate__animated", "animate__slideOutDown");
      ...
      if (direction == "bottom") {
        ...
        nextSiblings.forEach((e) => {
          e.classList.add("animate__animated", "animate__slideOutUp");
          e.style.setProperty("--animate-duration", "0.5s");
        });
      }
      // if (data == true) {
      ...
      //     targetCard.classList.add("animate__animated", "animate__slideOutDown");
      //     movedCard.classList.add("animate__animated", "animate__slideOutUp");

      //   } else {
      //     targetCard = movedCard.nextElementSibling;
      //     targetCard.classList.add("animate__animated", "animate__slideOutUp");
      //     movedCard.classList.add("animate__animated", "animate__slideOutDown");
      //   }
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      data.forEach((d) => {
        ...
        // bannerCard.classList.add("animate__animated","animate__shakeY");
        ...
        bannerImg.classList.add("banner-img", "h-full", "flex");
        // -------------------- img mobile
        const imgMobileContainer = document.createElement("div");
        imgMobileContainer.classList.add(
          "banner-mobile-img",
          "w-4/12",
          "flex",
          "justify-center",
        ...
        imgMobile.src = baseURL + "public/assets/images/" + d["mobile"];
        ...
        imgDesktopContainer.classList.add(
          "banner-mobile-img",
          "w-8/12",
          "flex",
          "justify-center",
        ...
        imgDesktop.src = baseURL + "public/assets/images/" + d["desktop"];
        ...
        upper.classList.add("flex", "relative", "left-0");
        ...
        top.classList.add(
          ...
          "rounded-full",
          "transition-all",
          "bg-[url('../images/arrow-to-top.png')]",
          "bg-center",
          "bg-no-repeat",
          "bg-cover",
        );
        ...
        upper.appendChild(up);
        // upper end

        // lower
        const lower = document.createElement("div");
        lower.classList.add("flex", "relative", "left-0");
        ...
        bottom.classList.add(
          ...
          "rounded-full",
          "transition-all",
          "bg-[url('../images/arrow-to-bottom.png')]",
          "bg-center",
          "bg-no-repeat",
          "bg-cover",
        );
        ...
        lower.appendChild(down);
        lower.appendChild(bottom);
        // lower end

        rightMenu.appendChild(lower);
        rightMenu.appendChild(upper);
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      if (parseInt(xhr.responseText) == 1) {
        ...
        banner.classList.add("animate__animated", "animate__zoomOutRight");
        setTimeout(() => {
          repopulateBanner();
        }, 500);
      }
...
beritaRow.forEach((row) => {
  ...
  editBtn.addEventListener("click", () => {
    ...
    id.value = idBerita;
    formEditBeritaPreview.src =
      baseURL + "public/assets/images/" + row.dataset.image;
