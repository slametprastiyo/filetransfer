...
class Admin extends CI_Controller
{
    ...
    public function banner_upload()
    {
        ...
        if (!$this->upload->do_upload('banner-mobile')) {
            ...
            // make mobile-thumbnail
            $mobileThumb = $path . "/" . $newName . "-mobile-copy.webp";
            $mobileThumbResized = $path . "/" . $newName . "-mobile-thumbnail.webp";
            copy("./public/assets/images/" . $mobileName, $mobileThumb);
            // make mobile-thumbnail end
            $this->resize_image($mobileThumb, $mobileThumbResized);
            die;
...
//         }
    ...
    private function resize_image($source_path, $target_path)
    {
        ...
        $config['width'] = 5; // Width of the thumbnail
        $config['height'] = 10; // Height of the thumbnail
