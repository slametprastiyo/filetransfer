...
console.log(localStorage.getItem("loaderCounter"));
      ...
      if (slide.classList.contains("first-slide")) {
        ...
        img.addEventListener("load",()=>{
          closeLoader();
			...
			if (!slide.classList.contains("slide-pencapaian-tahfidz")) {
				const pic = slide.querySelector("picture");
				const source = pic.querySelector("source");
				const img = pic.querySelector("img");
				source.srcset = baseURL + "public/assets/images/" + pic.dataset.desktop;
