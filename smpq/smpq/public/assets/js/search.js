export function searchOpen(keyword) {
  ...
  const resultBeritaContainer = searchResultSection.querySelector(".result-berita-container");
  const resultGaleriContainer = searchResultSection.querySelector(".result-galeri-container");
