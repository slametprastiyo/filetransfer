...
<!-- <body
    ...
    <header class="fixed main-header bottom-2 flex justify-center z-80 items-center w-full">
        ...
        <nav
            class="navigasi-baru hidden transition-all md:flex bg-white font-light rounded-xl text-secondary font-semibold text-xs px-0 pt-1 flex drop-shadow-lg items-center border border-white/30">
            ...
            <ul class="flex w-full items-center justify-center">
                ...
                <li class="mx-3 dropdown parent-menu relative flex flex-col items-center">
                    <img src="<?= base_url(); ?>public/assets/images/icons/profile-icon.png"
                        class="w-8 aspect-square object-contain menu-icon mb-1" alt="">
                ...
                <li class="mx-3">
                    <a href="<?= base_url(); ?>#galeri"
                        class="flex relative w-10  inline-block flex-col items-center justify-between  rounded-xl hover:rounded-2xl  transition-all  hover:scale-110 ">
                        <img src="<?= base_url(); ?>public/assets/images/icons/gallery-icon-white.png"
                            class="w-8 aspect-square object-contain menu-icon mb-1" alt="">
        ...
        <nav
            class="navigasi-baru navigasi-mobile md:hidden transition-all  bg-white font-light rounded-xl text-secondary font-semibold text-xs p-2 pt-1 flex drop-shadow-lg items-center border border-white/30">
            <ul class="flex w-full items-center justify-center">
                <li class="mx-3 mobile-menu">
                    <a href="<?= base_url() ;?>#"
                        class="flex relative w-10  inline-block flex-col items-center justify-between  rounded-xl hover:rounded-2xl  transition-all  hover:scale-110 ">
                        <img src="<?= base_url(); ?>public/assets/images/icons/home-icon.webp"
                ...
                <li
                    ...
                    <img src="<?= base_url(); ?>public/assets/images/icons/menu-icon.webp"
                        class="w-8 aspect-square object-contain" alt="">
                    <span>Menu</span>
                    <div
