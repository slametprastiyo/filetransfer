    ...
    <div class="featured p-1 flex flex-col md:flex-row gap-5 mb-5 items-stretch">
        <?php if ($recentNews != null): ?>
            <?php foreach ($recentNews as $key => $n): ?>
                <?php if ($key == 0): ?>
                    <div class="featured-main w-full aspect-video md:w-3/5 lg:w-8/12 shadow-custom rounded-xl overflow-hidden relative bg-center bg-cover hover:cursor-pointer" data-id="<?= $n['id'] ;?>" data-img="<?= $n['hd']; ?>">


                        <div class="detail absolute bottom-0 left-0 w-full h-full p-2  lg:p-10 flex items-end">
                            <h2 class="text-lg  md:text-2xl  text-white font-bold font-Montserrat">
                                <?= $n['title']; ?>
                            </h2>
                        </div>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="featured-nav w-full md:w-2/5 lg:w-4/12 bg-white p-2 rounded-3xl">
        ...
        <div class="berita-container w-full p-1 md:w-3/5 lg:w-8/12">
            <?php if ($recentNews != null): ?>
                <?php foreach ($recentNews as $key => $n): ?>
                    ...
                    ; ?>
                    <div class="berita-card hover:cursor-pointer w-full rounded-xl overflow-hidden  bg-white border flex mb-2"
