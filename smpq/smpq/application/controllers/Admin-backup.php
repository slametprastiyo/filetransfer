    ...
    public function galeri_upload()
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                // // Check if the file exists before calling getimagesize
                // if (file_exists($original_file_path)) {
                //     $imageInfo = getimagesize($original_file_path);
                //     $width = $imageInfo[0];
                //     $height = $imageInfo[1];
                //     $dimension = 'square';
                ...
                //     $this->resize_image($original_file_path, $upload_data['file_path'] . "thumb" . $upload_data['file_name']);
                //     $this->convert_to_webp_format("./public/assets/images/".$fileName.$file_extension, "./public/assets/images/".$fileName.".webp");
                //     $this->convert_to_webp_format("./public/assets/images/thumb".$fileName.$file_extension, "./public/assets/images/thumb".$fileName.".webp");

                //     if (file_exists("./public/assets/images/".$fileName.$file_extension)) {
                //         unlink("./public/assets/images/".$fileName.$file_extension);
                //     }
                //     if (file_exists("./public/assets/images/thumb".$fileName.$file_extension)) {
                //         unlink("./public/assets/images/thumb".$fileName.$file_extension);
                //     }

                //     if($this->input->post('isTahfidz')){
                //         $save = [
                //             'hd' => $fileName.".webp",
                //             'thumb' => "thumb" . $newFileName . ".webp",
                ...
                //         ];
                //     }
                //     $this->galeri_model->set_galeri($save);
                // } else {
                //     // Log the error and set a flash message
                //     log_message('error', 'File not found: ' . $original_file_path);
                //     $this->session->set_flashdata("error", "File not found: " . $original_file_path);
                //     redirect("admin/galeri");
                // }
            }
        }
