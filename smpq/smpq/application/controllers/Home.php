...
// var_dump($news);die;
	...
	foreach($popularNews as $n){
		...
		// var_dump($n);
		// echo "<hr>";
	array_push($popularNewsDateFormated, $n);
	}
// 	var_dump($recentNewsDateFormated);
// die;

	$galeries = $this->galeri_model->get_galeri();
	// var_dump($galeries);die;
		$data["banners"] = $banners;
		$data["recentNews"] = $recentNewsDateFormated;
		$data["popularNews"] = $popularNewsDateFormated;
		$data['user'] = $user;
