<section class="pt-10 mb-20 admin-home px-5 bg-gray-200 min-h-screen">
    ...
    <div class="menu-container grid grid-cols-4 gap-2 md:grid-cols-8 lg:grid-cols-12 mt-20">
        <a href="<?= base_url() ;?>pilketos/result" class="w-full bg-white rounded-xl uppercase p-2 hover:cursor-pointer flex justify-center items-center shadow-sm">
            pilketos
        </a>
    </div>
