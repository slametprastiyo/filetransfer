...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Bulan Mei 2025 pada 09.56
...
--
-- Struktur dari tabel `pilketos_dpt`
--
...
--
-- Dumping data untuk tabel `pilketos_dpt`
--
...
(10, 'Slamet Prastiyo', '0', 0, 'BZ35', NULL),
...
--
-- Struktur dari tabel `pilketos_kandidat`
--
...
--
-- Dumping data untuk tabel `pilketos_kandidat`
--
...
--
-- Indeks untuk tabel `pilketos_dpt`
--
ALTER TABLE `pilketos_dpt`
  ADD PRIMARY KEY (`nis`) USING BTREE;

--
-- Indeks untuk tabel `pilketos_kandidat`
--
